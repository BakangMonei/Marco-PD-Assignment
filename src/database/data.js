const sportsData = {
  Football: [
    {
      id: 1,
      imageUrl: 'https://images.pexels.com/photos/209956/pexels-photo-209956.jpeg?auto=compress&cs=tinysrgb&w=600', // Replace with actual image URL
    ...
    {
      id: 2,
      imageUrl: 'https://images.pexels.com/photos/50713/football-ball-sport-soccer-50713.jpeg?auto=compress&cs=tinysrgb&w=600',
      name: 'Football Match 2',
      venue: 'Stadium B',
      time: '01:00 PM',
      description: 'Another thrilling football match.'
    },
    // Add more football data
  ],
  Soccer: [
    {
      id: 1,
    ...
    },
    {
      ...
      venue: 'Field B',
      time: '06:00 PM',
      description: 'An exciting soccer match with local teams.'
    },
    // Add more soccer data
  ],
  Chess: [
    {
      id: 1,
