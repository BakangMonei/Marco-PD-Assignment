    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
                ...
                <div className="mb-6">
                    <button
                        className={`py-2 px-4 rounded ${editMode ? 'bg-blue-500 text-white' : 'bg-gray-500 text-white'}`}
                ...
                {editMode ? (
                    ...
                    <div>
                        ...
                        <p className="mb-2"><strong>Country:</strong> {userData.selectedCountry}</p>
                        <p className="mb-2"><strong>Sport:</strong> {userData.sport}</p>
                    </div>
                )}
                <div className="mt-6">
